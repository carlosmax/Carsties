...
public class AuctionControllerTests : IAsyncLifetime
{
    ...
    {
        // act
        var response = await _httpClient.GetFromJsonAsync<AuctionDto>($"api/auctions/{FORDGT_ID}");
    ...
    public async Task UpdateAuction_WithValidUpdateDtoAndUser_ShouldReturn200()
    {
        ...
        // act
        var response = await _httpClient.PutAsJsonAsync($"api/auctions/{FORDGT_ID}", updateAuction);
